...
type TabType = 'csv' | 'pdf' | 'materials';
...
export default function DrillAddQuestionsScreen() {
  ...
  // ── Materials: save document for chat context, NOT for question generation ──
  const handleUploadMaterial = async () => {
    try {
      ...
      Alert.alert('Saved!', `${file.name} added to ${subjectName}'s materials. The AI can now reference it in chat.`, [
        { text: 'OK', onPress: () => navigation.goBack() },
      ]);
    } catch (err: any) {
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.tabs}>
            ...
            >
              <Text style={[styles.tabText, tab === 'materials' && styles.tabTextActive]}>📚 Save Material</Text>
            </TouchableOpacity>
          </View>
          ...
          {/* ── Materials Tab — save for chat context, no question generation ── */}
          {tab === 'materials' && (
            <>
              <View style={styles.materialInfoCard}>
                <Text style={styles.materialInfoTitle}>📚 Build your subject library</Text>
              ...
              {!materialUploading ? (
                ...
                <View style={styles.generatingCard}>
                  ...
                  <Text style={styles.generatingTitle}>Saving your material...</Text>
                  <Text style={styles.generatingSubtitle}>Reading {materialName}</Text>
