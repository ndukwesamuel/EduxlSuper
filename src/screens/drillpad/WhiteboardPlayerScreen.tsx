...
// // ── Dummy scene data — matches your API response shape ─────────────
// const SCENES = [
//   { scene: 1, narration: 'CareerClarity NG is the talent intelligence ecosystem.', layout_type: 'TITLE', icon: '🌟', duration: 3.7 },
//   { scene: 2, narration: 'It helps students and professionals prepare, advise, track, and connect.', layout_type: 'FLOW_CHART', icon: '🎓', duration: 5.0 },
//   { scene: 3, narration: 'It offers personalized career paths based on skills and metrics.', layout_type: 'BULLET_LIST', icon: '📊', duration: 4.2 },
//   { scene: 4, narration: 'Employers and HR access talent through B2B APIs and dashboards.', layout_type: 'BULLET_LIST', icon: '🏢', duration: 5.3 },
//   { scene: 5, narration: 'Revenue streams include candidate subscriptions and employer access.', layout_type: 'COMPARISON', icon: '💰', duration: 4.3 },
//   { scene: 6, narration: 'This ecosystem drives global talent export and placement.', layout_type: 'TITLE', icon: '🌍', duration: 3.9 },
// ];

// const VIDEO_URL = 'https://res.cloudinary.com/dkzds0azx/video/upload/v1782052835/eduxl_whiteboard_videos/whiteboard_eduxl_1782052833683.mp4';
...
//   const topic      = route.params?.topic ?? 'eduxl';
//   const style      = route.params?.style ?? 'notebook';
...
//         <Text style={styles.title} numberOfLines={2}>{topic}</Text>
//         <View style={styles.metaRow}>
//           <Text style={styles.metaText}>🎬 {SCENES.length} scenes</Text>
//           <Text style={styles.metaDot}>·</Text>
//           <Text style={styles.metaText}>⏱ {formatTime(totalDuration)}</Text>
//           <Text style={styles.metaDot}>·</Text>
...
//                 </View>
//                 <Text style={styles.sceneDuration}>{s.duration.toFixed(1)}s</Text>
//               </View>
